/*
 * Copyright (C) 2016 huangstar_dev <huangstar_dev@163.com>
 ...
 * Created by huangstar on 2017/11/30.
 */
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.star.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.star.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
